...
export function BusinessMessages() {
  ...
  const PIPELINE_GROUPS = [
    {
      groupTitle: "Router Diagnostics",
      status: "ACTIVE",
      candidates: [
        { 
          id: 1, 
          name: "Davit N.", 
          lastMessage: "I just arrived at the site", 
          time: "10:42 AM", 
          avatar: "/Images/Davit.N.png",
          isAudio: false,
          triggerOnSite: true,
          taskTitle: "Router Diagnostics",
          taskBudget: "₾15"
        }
      ]
    },
    {
      groupTitle: "Office Network Setup",
      status: "REVIEWING",
      candidates: [
        { 
          id: 2, 
          name: "Luka G.", 
          lastMessage: "Audio Message (1:20)", 
          time: "Yesterday", 
          avatar: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=100&h=100",
          isAudio: true,
          triggerOnSite: false,
          taskTitle: "Office Network Setup",
          taskBudget: "₾35"
        }
      ]
    }
...
const BUSINESS_INITIAL_MESSAGES: ChatMessage[] = [
  ...
  { id: "b2", text: "I just arrived at the site", sender: "them", time: "10:42 AM" },
];

function BusinessChatDetail({ candidate, onBack }: { candidate: any; onBack: () => void }) {
  const { messages, sendMessage } = useChatEngine(BUSINESS_INITIAL_MESSAGES);
